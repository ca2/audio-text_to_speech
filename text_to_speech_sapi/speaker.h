...
#include "nano_speech_sapi/speech.h"
...
namespace text_to_speech_sapi
{
   ...
   //------------------------------------------------------------------------
   class CLASS_DECL_TEXT_TO_SPEECH_SAPI speaker :
   ...
   public:
      ...
      ::pointer < ::sapi::nano::speech::speech >   m_psapispeech;
      ...
      virtual ::sapi::nano::speech::speech* get_sapi_speech();
